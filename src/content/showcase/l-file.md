...
I still expect to make a lot of adjustments for stuff I haven't taken into account for. Even now, there's a few places that need to be polished like the detail page sub sections, but NOW the site looks like something competent that I am happy to properly showcase now.
