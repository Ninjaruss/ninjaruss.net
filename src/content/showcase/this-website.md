...
If you'd like to see the technical parts of the site (even though it isn't relatively complicated architecture-wise), you can find it [here](https://github.com/Ninjaruss/ninjaruss.net). It's using Astro and being hosted on Cloudflare Pages. Feel free to copy as you see fit. Just make sure to write your own thoughts without the LLM telling you what to do!
