...
**Her relationship to change.** She opposes it in others and restores instead — she takes Rain in to *be* Aster, training a dead man back into existence. The only character whose response to change is an attempted rollback.
...
**Where it's spent.** She isn't wise, she's avoidant: the training is armour. And she gets the arc where she receives instead of gives.

**Guard — never the serene disabled sage.** Her chair is not a source of insight. It is a wound with a named cause and a specific mechanic, and she is relentless rather than peaceful.
...
**Breaks at the Arc 4 reveal**, which is already staged flat, over a mundane task — the act showing up inside its own reveal scene. Somewhere in Arc 5 she asks for something instead of giving it; the lighter is the physical form.

### How it reaches the page

**Layer 1 — immediate · very bright / transparent.** Feeds people, touches people, hands you a task.

**Layer 2 — situational · bright / obscure.** She creates situations that keep her needed, and nobody in the story reads the giving as avoidance.

**Layer 3 — setting and concept · dark / obscure.** Total conservation on her own behalf. The lost memory of standing, the scars' meaning, what she cannot accept.

**The shape descends on both axes together** — bright-and-open down to dark-and-hidden. It is why the Arc 4 reveal lands: a straight shot to the bottom of the ladder.
