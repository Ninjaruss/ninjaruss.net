...
- One pitfall appears in each of Arcs 1–4.
- Arc 5 has no pitfall or ending choice.
...
5. Skipping reaches the ending faster; it does not break the loop.
...
Do not accuse the player, reveal a hidden punishment, or add a moral explanation. The intended response is recognition and grief, not embarrassment.

All four close on the notebook with one line written and the book shut. The second line appears only in the true ending.

### Reconvergence

Leaving a pitfall returns to the next spine scene.

- No persistent reward for leaving early.
- No penalty for having lingered.
- No hidden morality score.
- No required information locked behind replay.
...
- The player may enter different possible lives and remain for different lengths.
- They cannot see every life in one run.
- More lives create a larger graveyard on the mountain, but do not unlock a better ending.
- The player chooses when to stop entering lives. Rain ends the beloved life himself.
