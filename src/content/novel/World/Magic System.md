...
Resonance is strongest when an Imprint's completed transition and a person's unresolved transition share an emotional or behavioral shape. An Imprint can accumulate more than one layer of resonance over time.
...
- Claire pays through neurological and computational overload: Visual Calculus and Still Point run impossible computation on biological hardware.
